  ...
  return (
    ...
    >
      ...
      <div className="flex mt-[60px] flex-wrap justify-center items-center">
        <div className="bg-[white] xl:px-[35px] pr-[19px] xl:pb-[0px] pb-[30px] xl:h-[470px] poppins-regular pt-[70px] pl-[19px]  xl:basis-[34%] basis-[100%] xl:mb-[0px] mb-[30px]">
      ...
      <div className="flex justify-center">
        <div className="flex xl:mt-[60px] mt-[40px] flex-wrap justify-between w-[71%] mx-0 my-auto items-center ">
          <p className="xl:basis-[30%] basis-[100%]  custom-green flex lg:flex-col justify-center xl:items-start items-center playfair-display-600">
          ...
          <div className="flex justify-between xl:basis-[60%] xl:mt-0 mt-[20px] basis-[100%] items-center xl:flex-nowrap flex-wrap">
            <p className="flex lg:items-end items-center basis-[50%] xl:mb-0 mb-[30px] flex-col">
              <img
            ...
            <p className="flex lg:items-end items-center basis-[50%] flex-col">
              <img
                src={`${
                  import.meta.env.VITE_BASE_URL
                }assets/home/education.png`}
                className="block h-[50px] object-contain"
                alt="education"
              />
              <span className="text-center mt-[8px] text-[13px] uppercase">
