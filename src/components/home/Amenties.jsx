...
const Amenties = () => {
  ...
  const updateBackground = (newBg) => {
    ...
    tempImg.src = newBg;
    tempImg.className =
      "absolute top-0 left-0 lg:h-[auto] h-[100%] object-cover w-[100%] opacity-0 transition-opacity duration-300";
    ...
    <>
      ...
      <div style={{ display: "none" }}>
        {initialData.map((item, idx) => (
          <img loading="lazy" decoding="async" key={idx} src={item.bg} alt="" />
        ))}
      </div>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to top, rgba(0, 0, 0, 0.71) 0%, rgba(0, 0, 0, 0) 30.58%), linear-gradient(rgba(0, 0, 0, 0.71) 0%, rgba(0, 0, 0, 0) 50%)",
          }}
        ></div>

        <CommonHeading text={"AMENITIES"} textColor={"white"} />
        <h2 className="text-[white] z-[9] relative text-[19px] xl:text-[15px] xl:tracking-[2px] xl:leading-[28px] xl:pt-[40px] uppercase tracking-[1.5px] text-center !font-[300] playfair-display-400 leading-[30px]">
